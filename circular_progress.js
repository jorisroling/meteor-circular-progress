var direction = 1 // 1 for clock-wise   -1 for counter-clock-wise


Template.circularProgress.helpers({
...
Template.circularProgress.rendered = function() {
    ...
    var outerPadding = this.data.outerPadding || 0;
	...
	svg.append('circle')
	    .attr('cx',midPoint)
	    .attr('cy',midPoint)
	    .attr('r',innerRadius+((arcWidth/2)*3))
	    .attr('fill', '#FFFFFF')
    ...
    Deps.autorun(function() {
        ...
        progressBar.transition()
            ...
            .call(arcTween, direction * radians);
    });
